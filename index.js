...
//The variable internal is able to be inherited or passed down from myFunction to the nestedFunction.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const totalAnimals = array.reduce((acc, item) => acc + item.population, 0);
    return totalAnimals;
  }
